                ...
                <ScrollArea className="h-full min-h-0">
                  <Card className="p-2 flex flex-col">
                      ...
                      footerCustomization: multiVideoFooterCustomization
                        ...
                        {generatedMultiVideoBlob && <video src={URL.createObjectURL(generatedMultiVideoBlob)} controls className="w-full max-w-[420px] rounded-lg shadow-lg" style={{
                      aspectRatio: "9/16"
                    }} />}
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        {/* Caption generado - visible cuando existe */}
                        {generatedCaption && <div className="space-y-2">
                            <div className="flex items-center justify-between">
