...
export const MetricsPanel = ({
  ...
  return <Card className="p-6 bg-gradient-to-br from-primary/5 to-secondary/5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
        ...
        <div className="p-3 bg-white dark:bg-gray-800 rounded-lg">
          ...
          <p className="text-2xl font-bold text-green-800">{stats.last30Days}</p>
        </div>
        <div className="p-3 bg-white dark:bg-gray-800 rounded-lg">
      ...
      {isExpanded && <div className="space-y-3 animate-fade-in">
          <div className="p-3 bg-white dark:bg-gray-800 rounded-lg">
            ...
            <div className="space-y-1">
              {Object.entries(stats.byContentType).map(([type, count]) => <div key={type} className="flex justify-between text-xs">
          ...
          <div className="p-3 bg-white dark:bg-gray-800 rounded-lg">
            ...
            <div className="space-y-1">
              {Object.entries(stats.byPropertyType).map(([type, count]) => <div key={type} className="flex justify-between text-xs">
          ...
          {onClearMetrics && <Button variant="outline" size="sm" className="w-full" onClick={onClearMetrics}>
