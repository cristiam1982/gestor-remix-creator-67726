    ...
    return <div className="space-y-4 animate-fade-in">
        {!isLote && data.modalidad && <>
            ...
            <div>
              ...
              <Input id="ubicacion" value={data.ubicacion || ""} onChange={e => updateField("ubicacion", e.target.value)} placeholder="Ej: Chapinero, Calle 63 #10-20" className={errors?.ubicacion ? "border-destructive" : ""} />
        ...
        {isResidencial && <>
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input id="habitaciones" type="number" value={data.habitaciones || ""} onChange={e => updateField("habitaciones", e.target.value === "" ? undefined : parseInt(e.target.value))} placeholder="3" className={errors?.habitaciones ? "border-destructive" : ""} />
                {errors?.habitaciones && <p className="text-xs text-destructive mt-1">{errors.habitaciones}</p>}
              </div>
              <div>
                <Label htmlFor="banos">Baños</Label>
                <Input id="banos" type="number" value={data.banos || ""} onChange={e => updateField("banos", e.target.value === "" ? undefined : parseInt(e.target.value))} placeholder="2" className={errors?.banos ? "border-destructive" : ""} />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input id="parqueaderos" type="number" value={data.parqueaderos ?? ""} onChange={e => updateField("parqueaderos", e.target.value === "" ? 0 : parseInt(e.target.value))} placeholder="1" className={errors?.parqueaderos ? "border-destructive" : ""} />
                {errors?.parqueaderos && <p className="text-xs text-destructive mt-1">{errors.parqueaderos}</p>}
              </div>
              <div>
                <Label htmlFor="estrato">Estrato</Label>
                <Input id="estrato" type="number" value={data.estrato || ""} onChange={e => updateField("estrato", e.target.value === "" ? undefined : parseInt(e.target.value))} placeholder="3" min="1" max="6" className={errors?.estrato ? "border-destructive" : ""} />
        ...
        {isComercial && <>
            ...
            {data.tipo === "oficina" && <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="banos">Baños</Label>
                  <Input id="banos" type="number" value={data.banos || ""} onChange={e => updateField("banos", parseInt(e.target.value))} placeholder="2" />
                </div>
                <div>
                  <Label htmlFor="parqueaderos">Parqueaderos</Label>
                  <Input id="parqueaderos" type="number" value={data.parqueaderos || ""} onChange={e => updateField("parqueaderos", parseInt(e.target.value))} placeholder="1" />
                </div>
              </div>}

            {data.tipo === "oficina" && <div>
                <Label htmlFor="piso">Piso</Label>
                <Input id="piso" type="number" value={data.piso || ""} onChange={e => updateField("piso", parseInt(e.target.value))} placeholder="5" />
              </div>}
            ...
            {data.tipo === "bodega" && <div>
                <Label htmlFor="alturaLibre">Altura Libre (metros)</Label>
                <Input id="alturaLibre" value={data.alturaLibre || ""} onChange={e => updateField("alturaLibre", e.target.value)} placeholder="4.5" />
              </div>}
            ...
            {data.tipo === "local" && <div className="flex items-center space-x-2">
                <Checkbox id="vitrina" checked={data.vitrina || false} onCheckedChange={checked => updateField("vitrina", checked)} />
        ...
        {isLote && <>
            ...
            <div>
              <Label htmlFor="ubicacion">Ubicación</Label>
              <Input id="ubicacion" value={data.ubicacion || ""} onChange={e => updateField("ubicacion", e.target.value)} placeholder="Ej: Chia, Vereda La Balsa" className={errors?.ubicacion ? "border-destructive" : ""} />
              {errors?.ubicacion && <p className="text-xs text-destructive mt-1">{errors.ubicacion}</p>}
            </div>
          </>}
        ...
        <div>
          ...
          <Input id="area" type="number" value={data.area || ""} onChange={e => updateField("area", e.target.value === "" ? undefined : parseInt(e.target.value))} placeholder="80" className={errors?.area ? "border-destructive" : ""} />
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-2">
              ...
              return <button key={tipo} type="button" onClick={() => updateField("tipo", tipo)} className={`p-4 rounded-lg border-2 transition-all ${isSelected ? "border-secondary bg-secondary/10 shadow-md" : "border-border hover:border-secondary/50"}`}>
