...
export const BrandedHeroSection = ({ aliadoConfig }: BrandedHeroSectionProps) => {
  return (
    <div className="text-center mb-12 animate-fade-in">
      {/* Logos - Aliado y El Gestor */}
      <div className="flex items-center justify-between max-w-4xl mx-auto mb-8 px-4">
        {aliadoConfig.logo && (
          <img src={aliadoConfig.logo} alt={aliadoConfig.nombre} className="h-24 md:h-20 object-contain" />
        )}
